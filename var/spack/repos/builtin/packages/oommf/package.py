...
class Oommf(Package):
    """OOMMF is a project in the Applied and Computational Mathematics Division
       ...
       portable, extensible public domain programs and tools for
       micromagnetics. This code forms a completely functional micromagnetics
       ...
       that OOMMF operates across a wide range of Unix, Windows, and MacOSX
       platforms.
